...
module.exports = {
  async up(queryInterface, Sequelize) {
    // Drop the existing table with camelCase column names using raw SQL
    await queryInterface.sequelize.query('DROP TABLE IF EXISTS "sync_operations";', { type: QueryTypes.RAW });
    
    // Recreate with snake_case column names (consistent with other tables)
